...
GlobalAppSettings::GlobalAppSettings() :
    ...
    _copyOnSelect{ false },
    _copyFormatting{ static_cast<int>(CopyFormat::Plain) | static_cast<int>(CopyFormat::HTML) | static_cast<int>(CopyFormat::RTF) },
...
int GlobalAppSettings::GetCopyFormatting() const noexcept
{
