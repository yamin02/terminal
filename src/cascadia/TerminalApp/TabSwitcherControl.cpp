...
namespace winrt::TerminalApp::implementation
{
    TabSwitcherControl::TabSwitcherControl()
    {
        ...
        if (TabSwitcherControlShadow())
        {
            ...
            // version 18362.
            TabSwitcherControlShadow().Receivers().Append(ShadowBackdrop());
    ...
    //// Return Value:
    //// - <none>
    //void TabSwitcherControl::_selectNextItem(const bool moveDown)
    //{
    ...
    //// Return Value:
    //// - <none>
    //void TabSwitcherControl::_keyDownHandler(IInspectable const& /*sender*/,
    ...
    //        if (_tabSwitcherMode)
    //        {
    //            auto const state = CoreWindow::GetForCurrentThread().GetKeyState(VirtualKey::Control);
    ...
    //// Return Value:
    //// - <none>
    //void TabSwitcherControl::_filterTextChanged(IInspectable const& /*sender*/,
    ...
    //Collections::IObservableVector<Command> TabSwitcherControl::FilteredActions()
    //{
    //    return _filteredActions;
    //}

    //void TabSwitcherControl::SetActions(Collections::IVector<TerminalApp::Command> const& actions)
    //{
    //    _allActions = actions;
    //    _updateFilteredActions();
    //}
    ...
    //// Return Value:
    //// - <none>
    //void TabSwitcherControl::_updateFilteredActions()
    //{
    ...
    //    for (auto action : _allActions)
    //    {
    //        if (TabSwitcherControl::_filterMatchesName(searchText, action.Name()))
    //        {
    //            heap.push(action);
    //        }
    //    }
    ...
    //bool TabSwitcherControl::_filterMatchesName(const winrt::hstring& searchText, const winrt::hstring& name)
    //{
    ...
    //int TabSwitcherControl::_getWeight(const winrt::hstring& searchText,
